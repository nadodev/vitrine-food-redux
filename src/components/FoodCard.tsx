    ...
    return (
        <div className="border border-gray-200">
            <div className="text-center border-b border-gray-200">
                <img className="inline-block w-full h-[200px] object-cover" src={img} alt={title} height={200} />
            </div>
            ...
            <div className="px-8 py-4">
                ...
                <div className="flex flex-col items-start justify-between gap-4 mt-4">
                  ...
                  <button className="flex items-center gap-2 px-4 py-2 text-white cursor-pointer bg-sky-500 hover:bg-accent"
                    onClick={addProductToCart}>
                       <IoEye />
                       Ver Produto
                    </button>
                    <button className="flex items-center gap-2 px-4 py-2 text-white cursor-pointer bg-pink hover:bg-accent"
                    onClick={addProductToCart}>
